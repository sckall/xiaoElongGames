...
export const zhCN: Record<string, string> = {
  ...
  // ============ event（活动中心，EventCenterScreen.tsx） ============
  'event.banner.tag': '限时活动',
  'event.banner.title': '春日赏花祭',
  'event.banner.subtitle': '参与限时活动，赢取限定头像框 + 200 金币',
  'event.banner.countdown': '距活动结束',
  'event.banner.cta': '立即参与',
  'event.section.active': '进行中的活动',
  'event.section.active.meta': '共 {count} 个活动',
  'event.section.daily': '每日任务 / 福利',
  'event.section.daily.meta': '每日 00:00 刷新',
  'event.tag.hot': '🔥 热门',
  'event.tag.new': 'NEW',
  'event.tag.limited': '限时',
  'event.tag.guild': '社团',
  'event.tag.newbie': '新人',
  'event.card.reward': '奖励',
  'event.card.cta': '前往',
  'event.card.claimed': '已领取',
  'event.daily.claim': '领取',
  'event.daily.claimed': '已领取',
};